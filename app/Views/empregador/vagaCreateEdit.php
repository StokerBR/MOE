                        ...
                        <div class="card-content black-text">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input id="descricao" type="text" name="descricao" placeholder="Descrição" maxlength="200" value="<?= old('descricao', ($isEdit ? $vaga['descricao'] : '')) ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <textarea id="lista_atividades" class="materialize-textarea" name="lista_atividades" required><?= old('lista_atividades', ($isEdit ? $vaga['lista_atividades'] : '')) ?></textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <textarea id="lista_habilidades" class="materialize-textarea" name="lista_habilidades" required><?= old('lista_habilidades', ($isEdit ? $vaga['lista_habilidades'] : '')) ?></textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col m4 s12">
                                    ...
                                    <input id="semestre_requerido" type="number" min='1' name="semestre_requerido" placeholder="Semestre" value="<?= old('semestre_requerido', ($isEdit ? $vaga['semestre_requerido'] : '')) ?>" required>
                                </div>

                                <div class="input-field col m4 s12">
                                    <i class="material-icons prefix">paid</i>
                                    <label for="remuneracao">Remuneração (R$) <span class="required">*</span></label>
                                    <input id="remuneracao" type="number" step="0.01" min='600' name="remuneracao" placeholder="Remuneração" value="<?= old('remuneracao', ($isEdit ? $vaga['remuneracao'] : '')) ?>" required>
                                </div>
                                ...
                                <div class="input-field col m4 s12">
                                    ...
                                    <select id="quantidade_horas" name="quantidade_horas" required>
                                        ...
                                        <option value="20" <?= old('quantidade_horas', ($isEdit ? $vaga['quantidade_horas'] : '')) == 20 ? 'selected' : '' ?>>20h</option>
                                        <option value="30"<?= old('quantidade_horas', ($isEdit ? $vaga['quantidade_horas'] : '')) == 30 ? 'selected' : '' ?>>30h</option>
                                    </select>
